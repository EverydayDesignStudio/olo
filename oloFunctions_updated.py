...
def readValues():
    ...
    sh.values[0] = ch0.value
    sh.values[1] = ch1.value
    sh.values[2] = ch2.value
    sh.values[3] = ch3.value
    sh.values[4] = ch4.value
    sh.values[5] = ch5.value
    sh.values[6] = ch6.value
    sh.values[7] = ch7.value
